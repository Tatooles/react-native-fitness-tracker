                ...
                <View style={styles.cont}>
                    ...
                    <View style={styles.subContainer}>
                        <Pressable
                            ...
                            accessibilityHint="Opens a screen which allows you to edit this meal"
                            onPress={() => this.props.edit(this.props.id, this.props.name, this.props.calories, this.props.protein, this.props.carbs, this.props.fat, this.props.date)}>
                            <Icon
                                name="edit"
                                color="#942a21"
                                size={30}
                        ...
                        <Pressable
                            ...
                            accessibilityHint="Deletes this meal from the list"
